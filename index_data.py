...
info = get_dataset_config_info("facebook/kilt_wikipedia")
print(info.splits["full"].num_examples)
...
with open("data/chunk_store.pkl", "wb") as f:
    pickle.dump(chunk_store, f)
print(f"Chunk store persisted: {len(chunk_store)} entries")
